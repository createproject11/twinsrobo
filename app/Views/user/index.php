<?= $this->extend('/templates/landpage_user'); ?>
        ...
        <div class="row">
            <div class="col-lg-5 side-judul" data-aos="fade-left">
                <div class="cont-judul">
                    <h1 class="judul">
                        Belajar Robotika <br>
                        Hanya Satu Genggaman
                    </h1>
                    <p class="desc-judul">
                        Belajar robotika dikemas secara fun dan langsung di implentasikan
                        kedalam robot secara wirelessly dan hanya satu genggaman
                    </p>

                    <a class="btn-download" href="" class="download">
                        Download Now
                    </a>
                </div>
            </div>
...
<!-- Fitur Page -->
<section class="fitur-page">
    <div class="container">
        <div class="cont-judul text-center">
            <h2>FITUR Twins Robo</h2>
        </div>
            ...
            <div class="row m-baris">
                ...
                <div class="col-md-6 isi-fitur aos-init aos-animate" data-aos="fade-right" data-aos-delay="400">
                    ...
                    <p>upload scoremu dan raih waktu terbaik bersama teman-teman kalian.
                        ...
                        pengguna aplikasi twins robo.</p>
                </div>
            </div>
            <!-- End of Mini Games -->
...
<section class="intro-page">
    <div class="container">
        <div class="cont-judul text-center">
            <h2>
                Kenalkan,Twins Robo. <br>
                Si Ringkas Hanya Satu Genggaman
            </h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 text-center aos-init aos-animate" data-aos="zoom-in-up" data-aos-delay="600">
                    ...
                    <p>Aplikasi Twins Robo ini banyak sekali materi-materi yang diajarkan oleh pelatih-pelatih robot dan
                        programmer profesional sehingga lebih terarah.</p>
                </div>
                <!-- End of Diajarkan Bersama Mentor -->
            </div>
        </div>
    </div>
</section>
