                ...
                <div class="card">
                    <div class="card-head">
                        <div class="container">
                            ...
                            <p class="sub-title">Akses kelas gratis untuk yang memulai belajar code dan design </p>
                        </div>
                    </div>
                    <!-- Akhir Card-Head -->
                ...
                <div class="card">
                    <div class="card-head">
                        <div class="container">
                            ...
                            <p class="sub-title">Materi lanjutan dari kelas Starter & belajar membangun projek </p>
                        </div>
                    </div>
                    <!-- Akhir Card-Head -->
                    <hr class="mx-3" width="90%">
                ...
                <div class="card">
                    <div class="card-head">
                        <div class="container">
                            ...
                            <p class="sub-title">Mengikuti kelas dengan waktu yang terbatas dan biaya lebih hemat</p>
                        </div>
                    </div>
                    <!-- Akhir Card-Head -->
                    <hr class="mx-3" width="90%">
