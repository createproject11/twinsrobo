                ...
                <div class="card">
                    <div class="card-head">
                        <div class="container">
                            ...
                            <p class="sub-title">Rp <span class="font-weight-bold head-span">300.000</span> per 3 bulan</p>
                        </div>
                    </div>
                    <!-- Akhir Card-Head -->
                ...
                <div class="card">
                    <div class="card-head">
                        <div class="container">
                            ...
                            <p class="sub-title">Rp <span class="font-weight-bold head-span">550.000</span> per 5 bulan </p>
                        </div>
                    </div>
                    <!-- Akhir Card-Head -->
                    <hr class="mx-3" width="90%">
                ...
                <div class="card">
                    <div class="card-head">
                        <div class="container">
                            ...
                            <p class="sub-title">Rp <span class="font-weight-bold head-span">700.000</span> per 3 bulan </p>
                        </div>
                    </div>
                    <!-- Akhir Card-Head -->
                    <hr class="mx-3" width="90%">
