...
<div class="Pembelajaran2">
    <div class="container">
        ...
        <div class="row text-center offset-sm-3 mt-4">
            <div class="col-sm-2">
                <p>Member</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 sisiKanan">
                    <div class="rightSidebar" style="width: 100%; background: #1D79B2; border-radius: 26px;">
                        ...
                        <a class="btn tombol" href="">Gabung Kelas</a>
